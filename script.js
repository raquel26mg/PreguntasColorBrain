const cards = [
    { question: "Colores de la bandera de Francia", answer: ["Azul", "Blanco", "Rojo"], colors: ["#0055A4", "#FFFFFF", "#EF4135"], number: 3 },
    { question: "Colores de la bandera de Italia", answer: ["Verde", "Blanco", "Rojo"], colors: ["#009246", "#FFFFFF", "#CE2B37"], number: 3 },
    { question: "Color del cielo durante el día", answer: ["Azul"], colors: ["#1E90FF"], number: 1 },
    { question: "Colores de una sandía por dentro y por fuera", answer: ["Rojo", "Verde"], colors: ["#FC3D32", "#4CAF50"], number: 2 }
];
